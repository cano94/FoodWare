...
var _View_RadioButton_Host0 = (function (_super) {
    ...
    function _View_RadioButton_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_RadioButton_Host0, renderType_RadioButton_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_RadioButton_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._RadioButton_0_4 = new import3.RadioButton(this.parentInjector.get(import8.Form), this.parentInjector.get(import9.Config), new import10.ElementRef(this._el_0), this.renderer, this.parentInjector.get(import11.Item, null), this.parentInjector.get(import12.RadioGroup, null));
    ...
    _View_RadioButton_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.RadioButton) && (0 === requestNodeIndex))) {
            return this._RadioButton_0_4;
        }
        return notFoundResult;
    };
    _View_RadioButton_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._RadioButton_0_4.ngOnInit();
        }
        this.detectContentChildrenChanges(throwOnChange);
        var currVal_1 = this._RadioButton_0_4._disabled;
    ...
    _View_RadioButton_Host0.prototype._handle_click_0_0 = function ($event) {
        ...
        var pd_0 = (this._RadioButton_0_4._click($event) !== false);
        return (true && pd_0);
    };
...
export var RadioButtonNgFactory = new import14.ComponentFactory('ion-radio', viewFactory_RadioButton_Host0, import3.RadioButton);
...
var _View_RadioButton0 = (function (_super) {
    ...
    function _View_RadioButton0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_RadioButton0, renderType_RadioButton, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_RadioButton0.prototype.createInternal = function (rootSelector) {
        ...
        this._Button_5_4 = new import15.Button(null, 'item-cover', this.parentInjector.get(import9.Config), new import10.ElementRef(this._el_5), this.renderer);
    ...
    _View_RadioButton0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import15.Button) && ((5 <= requestNodeIndex) && (requestNodeIndex <= 6)))) {
...
export function viewFactory_RadioButton0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_RadioButton === null)) {
        (renderType_RadioButton = viewUtils.createRenderComponentType('C:/Users/cano/Desktop/New folder/authApp/node_modules/ionic-angular/components/radio/radio-button.d.ts class RadioButton - inline template', 0, import13.ViewEncapsulation.None, styles_RadioButton, {}));
    }
