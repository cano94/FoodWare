...
var renderType_OldReports_Host = null;
var _View_OldReports_Host0 = (function (_super) {
    __extends(_View_OldReports_Host0, _super);
    function _View_OldReports_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_OldReports_Host0, renderType_OldReports_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_OldReports_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-old-reports', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_OldReports0(this.viewUtils, this.injector(0), this._appEl_0);
        this._OldReports_0_4 = new import3.OldReports(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._OldReports_0_4, [], compView_0);
        compView_0.create(this._OldReports_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_OldReports_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.OldReports) && (0 === requestNodeIndex))) {
            return this._OldReports_0_4;
        }
        return notFoundResult;
    };
    return _View_OldReports_Host0;
}(import1.AppView));
function viewFactory_OldReports_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_OldReports_Host === null)) {
        (renderType_OldReports_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_OldReports_Host0(viewUtils, parentInjector, declarationEl);
}
export var OldReportsNgFactory = new import10.ComponentFactory('page-old-reports', viewFactory_OldReports_Host0, import3.OldReports);
var styles_OldReports = [];
var renderType_OldReports = null;
var _View_OldReports0 = (function (_super) {
    __extends(_View_OldReports0, _super);
    function _View_OldReports0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_OldReports0, renderType_OldReports, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_OldReports0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, 'old-reports', null);
        ...
        this._text_13 = this.renderer.createText(this._el_12, 'Eski tarihli raporlar', null);
    ...
    _View_OldReports0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import14.Content) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._Content_10_4;
        }
        return notFoundResult;
    };
    _View_OldReports0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_OldReports0.prototype.destroyInternal = function () {
        this._Content_10_4.ngOnDestroy();
    };
    return _View_OldReports0;
}(import1.AppView));
